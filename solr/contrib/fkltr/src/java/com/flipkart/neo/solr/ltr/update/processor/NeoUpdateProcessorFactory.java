...
public class NeoUpdateProcessorFactory extends UpdateRequestProcessorFactory implements SolrCoreAware {
  ...
  public void inform(SolrCore core) {
    log.info("initialising neo collection");
    ...
    metricPublisher = new MetricPublisher(core.getMetricRegistry(), METRICS_PREFIX);
    ...
    neoScoringModule = new NeoScoringModuleImpl(modelMysqlConfig, getActiveModelsRetriever(dynamicConfigBucket),
        modelRefreshPeriodInSeconds, bannerCacheInitialSize, neoFKLTRConfigs, core.getMetricRegistry(), isStaticModelsEnabled);
  ...
  private FKLTRDocumentScorer<NeoRescoringContext, ScoreMeta> createFKLTRDocumentScorer(
    ...
    Parallelizer parallelizer = new Parallelizer(parallelizerNumThreads, core.getMetricRegistry(), NEO);
